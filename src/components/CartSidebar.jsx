...
const CartSidebar = () => {
  ...
  const isOpen = useSelector((state) => state.cart.cartSidebar);
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <div className="flex items-center justify-center">
                    <button
                      ...
                      className="px-36 py-3 mt-6 text-black font-light border-black border-[1px] bg-white rounded-3xl hover:text-white hover:bg-black"
                    >
                      View Cart
                    </button>
                  </div>
                  ...
                  <div className=" flex items-center justify-center">
                    <button
                      className="px-36 py-3 mt-3 font-light border-black border-[1px]  rounded-3xl text-white bg-black"
                    >
                      Checkout
                    </button>
                  </div>
